...
from TanishaRobot import OWNER_ID, pbot
from TanishaRobot.utils.admins import can_change_info
from TanishaRobot.utils.errors import capture_err
from TanishaRobot.utils.mongo import (
    alpha_to_int,
    get_karma,
    get_karmas,
    int_to_alpha,
...
async def upvote(_, message):
    ...
    await message.reply_text(
        f"❖ ɪɴᴄʀᴇᴍᴇɴᴛᴇᴅ ᴋᴀʀᴍᴀ ᴏғ {user_mention} ʙʏ 1\n**● ᴛᴏᴛᴀʟ ᴩᴏɪɴᴛs ➥** {karma}\n\n❖ ᴘᴏᴡᴇʀᴇᴅ ʙʏ ➥ ๛ᴛ ᴀ ɴ ɪ s ʜ ᴀ ࿐", reply_markup=InlineKeyboardMarkup(EVAA),
    )
