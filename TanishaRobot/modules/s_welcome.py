...
from TanishaRobot.database.wel_db import *
...
def welcomepic(pic, user, chat, id, uname):
    background = Image.open("TanishaRobot/resources/bg.jpg")
    ...
    font = ImageFont.truetype('TanishaRobot/resources/SwanseaBold-D0ox.ttf', size=44)
    welcome_font = ImageFont.truetype('TanishaRobot/resources/SwanseaBold-D0ox.ttf', size=90)
...
❖ ᴘᴏᴡᴇʀᴇᴅ ʙʏ ➥ [๛ᴛ ᴀ ɴ ɪ s ʜ ᴀ ࿐](https://t.me/ll_Feelings_ll)**
▰▱▱▱▱▱▱▱▱▱▱▱▱▱▱▱▱▰
""",
