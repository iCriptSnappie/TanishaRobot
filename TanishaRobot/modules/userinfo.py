...
from TanishaRobot.modules.alive import Avisha
import TanishaRobot.modules.sql.userinfo_sql as sql
...
from TanishaRobot.__main__ import STATS, TOKEN, USER_INFO
from TanishaRobot.modules.disable import DisableAbleCommandHandler
from TanishaRobot.modules.helper_funcs.chat_status import sudo_plus
from TanishaRobot.modules.helper_funcs.extraction import extract_user
from TanishaRobot.modules.sql.global_bans_sql import is_user_gbanned
from TanishaRobot.modules.sql.users_sql import get_user_num_chats
...
def info(update: Update, context: CallbackContext):
    ...
    if disaster_level_present:
        text += ' \n⬤ [<a href="https://t.me/KernelKnight/16">ᴄʟɪᴄᴋ ʜᴇʀᴇ ᴛᴏ ᴋɴᴏᴡ ᴡʜᴀᴛ ɪs ᴅɪsᴀsᴛᴇʀ ʟᴇᴠᴇʟs.</a>]'.format(
            bot.username
        )
            ...
            message.reply_photo(
                ...
                reply_markup=InlineKeyboardMarkup(
                    [
                        [
                            InlineKeyboardButton(
                                "ʜᴇᴀʟᴛʜ", url=f"https://t.me/KernelKnight/17"
                            ),
                            InlineKeyboardButton(
                                "ᴅɪsᴀsᴛᴇʀ", url="https://t.me/KernelKnight/16"
                            ),
                        ],
                    ]
                ),
            ...
            message.reply_text(
                ...
                reply_markup=InlineKeyboardMarkup(
                    [
                        [
                            InlineKeyboardButton(
                                "ʜᴇᴀʟᴛʜ", url="https://t.me/KernelKnight/17"
                            ),
                            InlineKeyboardButton(
                                "ᴅɪsᴀsᴛᴇʀ", url="https://t.me/KernelKnight/16"
                            ),
