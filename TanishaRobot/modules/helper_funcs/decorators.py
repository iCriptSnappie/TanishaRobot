...
from TanishaRobot import LOGGER
from TanishaRobot import dispatcher as n
from TanishaRobot.modules.disable import DisableAbleCommandHandler, DisableAbleMessageHandler
...
class AvishaTelegramHandler:
    ...
    def message(
        ...
        def _message(func):
            try:
                ...
                LOGGER.debug(
                    f"[TanishaRobot-Msg] Loaded filter pattern {pattern} for function {func.__name__}"
                )
    ...
    def callbackquery(self, pattern: str = None, run_async: bool = True):
        def _callbackquery(func):
            ...
            LOGGER.debug(
                f"[TanishaRobot-Callback] Loaded callbackquery handler with pattern {pattern} for function {func.__name__}"
            )
            return func
